...
def update_menu(result, discard_list, selected_list):
    ...
    breakfast_final_list, lunch_list, dinner_list, calories_list, alternative_breakfast_list, alternative_lunch_list, alternative_dinner_list
    main_list = breakfast_final_list + lunch_list + dinner_list
    alternative_list = alternative_breakfast_list + alternative_lunch_list + alternative_dinner_list
    ...
    for i in range(len(selected_list)):
        ...
        alternative_list[selected_list[i]] = dish_to_discard

    breakfast_final_list = main_list[0:7]
    lunch_list = main_list[7:14]
    dinner_list = main_list[14:21]
    alternative_breakfast_list = alternative_list[0:7]
    alternative_lunch_list = alternative_list[7:14]
    alternative_dinner_list = alternative_list[14:21]
    new_calories_list = []
    for i in range(7):
