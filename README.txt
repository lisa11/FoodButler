...
The file old_test_data contains some outputs generated by previous trials we ran.

The complete list of available input for ingredients to include/avoid can be found at /old_test_data/search_values.json or /old_test_data/search_values.txt

Entering an ingredient that is not in that list will make that input invalid and therefore be ignored